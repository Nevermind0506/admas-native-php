<?php 
    ...
    if (!empty($_SESSION['nik_login'])) {
        ...
        $sql_peng_all = "SELECT * FROM pengaduan INNER JOIN masyarakat on masyarakat.nik = pengaduan.nik
        ...
        header("Content-Disposition: attachment; filename=report_total_pengaduan.xls");
?>
